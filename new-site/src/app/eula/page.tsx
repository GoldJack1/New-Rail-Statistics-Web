...
const EulaPage: React.FC = () => {
  ...
  return (
    <div className="container container--station-details">
      ...
      />
      <div className="eula-page legal-docs-page">
        <div className="eula-layout legal-docs-layout station-details-layout">
          <LegalDocsSectionNav
            sections={sections}
            activeSectionId={activeSectionId}
            onSelect={handleSelectSection}
            ariaLabel="EULA sections"
          />

          <main className="eula-content legal-docs-main station-details-main">
            <div className="legal-docs-card">
              {activeSectionId === 'section-1' && (
                <section className="eula-section">
                  ...
                  <div className="eula-intro-block">
              ...
              {activeSectionId === 'section-2' && (
                ...
                <ul>
                  <li id={legalDocsSubsectionId('2.1')}><strong>2.1</strong> You are given a non-transferable, non-exclusive, non-sublicensable licence to install and use the Licensed Application on any Devices that You (End-User) own or control and as permitted by the Usage Rules, with the exception that such Licensed Application may be accessed and used by other accounts associated with You (End-User, The Purchaser) via Family Sharing or volume purchasing.</li>
                  <li id={legalDocsSubsectionId('2.2')}><strong>2.2</strong> This licence will also govern any updates of the Licensed Application provided by Licensor that replace, repair, and/or supplement the first Licensed Application, unless a separate licence is provided for such update, in which case the terms of that new licence will govern.</li>
                  <li id={legalDocsSubsectionId('2.3')}><strong>2.3</strong> You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with Rail Statistics&apos;s prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application.</li>
                  <li id={legalDocsSubsectionId('2.4')}><strong>2.4</strong> You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with Rail Statistics&apos;s prior written consent).</li>
                  <li id={legalDocsSubsectionId('2.5')}><strong>2.5</strong> You may not copy (excluding when expressly authorised by this licence and the Usage Rules) or alter the Licensed Application or portions thereof. You may create and store copies only on devices that You own or control for backup keeping under the terms of this licence, the Usage Rules, and any other terms and conditions that apply to the device or software used. You may not remove any intellectual property notices. You acknowledge that no unauthorised third parties may gain access to these copies at any time. If you sell your Devices to a third party, you must remove the Licensed Application from the Devices before doing so.</li>
                  <li id={legalDocsSubsectionId('2.6')}><strong>2.6</strong> Violations of the obligations mentioned above, as well as the attempt of such infringement, may be subject to prosecution and damages.</li>
                  <li id={legalDocsSubsectionId('2.7')}><strong>2.7</strong> Licensor reserves the right to modify the terms and conditions of licensing.</li>
                  <li id={legalDocsSubsectionId('2.8')}><strong>2.8</strong> Nothing in this licence should be interpreted to restrict third-party terms. When using the Licensed Application, You must ensure that You comply with applicable third-party terms and conditions.</li>
                </ul>
              </section>
            )}
            ...
            {activeSectionId === 'section-3' && (
              <section className="eula-section">
                ...
                <ul>
                  <li id={legalDocsSubsectionId('3.1')}><strong>3.1</strong> The Licensed Application requires a firmware version 26.03.1 or higher. Licensor recommends using the latest version of the firmware.</li>
                  <li id={legalDocsSubsectionId('3.2')}><strong>3.2</strong> Licensor attempts to keep the Licensed Application updated so that it complies with modified/new versions of the firmware and new hardware. You are not granted rights to claim such an update.</li>
                  <li id={legalDocsSubsectionId('3.3')}><strong>3.3</strong> You acknowledge that it is Your responsibility to confirm and determine that the app end-user device on which You intend to use the Licensed Application satisfies the technical specifications mentioned above.</li>
                  <li id={legalDocsSubsectionId('3.4')}><strong>3.4</strong> Licensor reserves the right to modify the technical specifications as it sees appropriate at any time.</li>
                </ul>
              </section>
            )}
            ...
            {activeSectionId === 'section-4' && (
              <section className="eula-section">
                ...
                <ul>
                  <li id={legalDocsSubsectionId('4.1')}><strong>4.1</strong> The Licensor is solely responsible for providing any maintenance and support services for this Licensed Application. You can reach the Licensor at the email address listed in the App Store or Play Store Overview for this Licensed Application.</li>
                  <li id={legalDocsSubsectionId('4.2')}><strong>4.2</strong> Rail Statistics and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.</li>
                </ul>
              </section>
            )}
            ...
            {activeSectionId === 'section-8' && (
              <section className="eula-section">
                ...
                <ul>
                  <li id={legalDocsSubsectionId('8.1')}><strong>8.1</strong> Licensor&apos;s responsibility in the case of violation of obligations and tort shall be limited to intent and gross negligence. In case of a breach of essential contractual duties, Licensor shall also be liable for slight negligence. Liability is limited to foreseeable, contractually typical damages, except for injuries to life, limb, or health.</li>
                  <li id={legalDocsSubsectionId('8.2')}><strong>8.2</strong> Licensor takes no accountability for damages caused by a breach of duties in Section 2. You are required to use backup functions to avoid data loss.</li>
                  <li id={legalDocsSubsectionId('8.3')}><strong>8.3</strong> Licensor takes no responsibility if unsafe use or misuse of the application on railway/metro/tram networks causes injuries or breaches of the network/service/operators terms of service or condtion of carriage; the liability falls on the user.</li>
                </ul>
              </section>
            )}
            ...
            {activeSectionId === 'section-9' && (
              <section className="eula-section">
                ...
                <ul>
                  <li id={legalDocsSubsectionId('9.1')}><strong>9.1</strong> Licensor warrants the application is free of malware at the time of download and works as described in documentation.</li>
                  <li id={legalDocsSubsectionId('9.2')}><strong>9.2</strong> No warranty is provided for applications that are non-executable due to unauthorised modification, inappropriate handling, or use with inappropriate hardware/software.</li>
                  <li id={legalDocsSubsectionId('9.3')}><strong>9.3</strong> You must inspect the application immediately and notify Rail Statistics of issues within fourteen (14) days of discovery.</li>
                  <li id={legalDocsSubsectionId('9.4')}><strong>9.4</strong> If defective, Rail Statistics may remedy the situation or provide a substitute.</li>
                  <li id={legalDocsSubsectionId('9.5')}><strong>9.5</strong> In case of warranty failure, you may notify the Store Operator for a refund of the purchase price. The Store Operator has no other warranty obligations.</li>
                  <li id={legalDocsSubsectionId('9.6')}><strong>9.6</strong> For entrepreneurs, claims expire after twelve (12) months; for consumers, statutory periods apply.</li>
                </ul>
              </section>
            )}

            {activeSectionId === 'section-10' && (
              <section className="eula-section">
            ...
            {activeSectionId === 'section-17' && (
              <section className="eula-section">
                <h2 id="section-17">17. MISCELLANEOUS</h2>
                <ul>
                  <li id={legalDocsSubsectionId('17.1')}><strong>17.1</strong> If any term becomes invalid, the remaining provisions remain valid. Invalid terms will be replaced by valid ones achieving the primary purpose.</li>
                  <li id={legalDocsSubsectionId('17.2')}><strong>17.2</strong> Amendments are only valid if laid down in writing.</li>
                </ul>
              </section>
            )}
            </div>
